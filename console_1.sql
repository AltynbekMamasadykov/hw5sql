...
SELECT * FROM products WHERE price = 46000 OR price > 46000;
...
SELECT SUM(price) AS totalPriceOfAllProducts FROM products;

-- 10. Эки жана андан аз продуктусу бар компанияларды алыныз
SELECT company, COUNT(*) AS productsCount FROM products GROUP BY company HAVING COUNT(*) < 3;
